...
vi.mock("./components/CVViewer", () => ({ default: () => <div data-testid="cv-viewer">CV</div> }));
vi.mock("./App.css", () => ({}));
...
describe("App — home render", () => {
  ...
  it("renders experience section", () => { render(<App />); expect(screen.getByTestId("experience-section")).toBeInTheDocument(); });
  it("renders education section", () => { render(<App />); expect(screen.getByTestId("education-section")).toBeInTheDocument(); });
