...
const WHAT_I_DO = [
  {
    ...
    desc: "Building responsive UIs with React, Next.js, and Vue.js.",
  },
  {
    title: "Backend Development",
    desc: "Node.js, Express.js, and PHP REST APIs backed by PostgreSQL and MongoDB.",
  },
  {
    title: "Workflow Automation",
    desc: "AI-powered business pipelines with n8n, Zapier, Make.com, and Airtable.",
  },
  {
    title: "REST API Integration",
    desc: "Designing schemas and endpoints for full-stack CRUD applications.",
  },
];
...
const EXPERIENCE = [
  ...
  },
  {
    ...
    points: [
      "Assisted in day-to-day business operations and administrative tasks",
    ],
  },
];
      ...
      <div className="min-h-screen flex flex-col relative overflow-hidden bg-gray-900 text-white">
                  ...
                  <div className="flex flex-wrap justify-center gap-3">
                    {([{
                      ...
                      <a
                        key={item.label}
                        href={item.href}
                        className="inline-block px-4 py-2 rounded-lg font-semibold border border-[rgba(59,130,246,0.35)] bg-[rgba(6,10,18,0.75)] text-blue-200 shadow-[0_0_18px_rgba(59,130,246,0.15)] hover:bg-[rgba(59,130,246,0.16)] hover:scale-[1.02] transition-all duration-300 text-sm sm:text-base"
                      >
                        {item.label}
                      </a>
                    ))}
                    ...
                    <div className="bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)] rounded-2xl p-5 sm:p-6 shadow-lg glow-section">
                      ...
                      <div className="mt-5 space-y-3">
                        {[
                          ...
                          {
                            label: "LOCATION",
                            value: "Menden (Sauerland), Germany",
                          },
                        ].map(({ label, value }) => (
                          <div
                            key={label}
                        ...
                        <div className="mt-4 flex items-center justify-center gap-4 text-gray-300 flex-wrap">
                          ...
                          <a
                            href="https://linkedin.com/in/odionmurphy"
                            target="_blank"
                            rel="noreferrer"
                            className="hover:text-blue-400 text-sm transition-colors"
                          >
                  ...
                  <div className="md:col-span-2">
                    <div className="p-5 sm:p-6 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.03)] rounded-2xl glow-section">
                      ...
                      <p className="text-gray-300 mb-6 text-sm sm:text-base leading-relaxed">
                        Equipped with a rigorous, two-year Full-Stack training
                        foundation from the Digital Career Institute and
                        specialized expertise in AI-driven process automation, I
                        focus on writing clean, efficient code, building robust
                        APIs, and creating seamless user experiences. From
                        production websites to backend systems and automation
                        pipelines, I care about how things work under the hood,
                        not just how they look, and I'm ready to bring that
                        mindset to a collaborative team.
                      </p>
        ...
        <footer className="site-footer pt-10 sm:pt-12 pb-6 px-4 sm:px-6 text-sm">
          <div className="container mx-auto flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col sm:items-end gap-2 text-xs sm:text-sm text-gray-400">
              <a
                href="mailto:djmurphy041@gmail.com"
                className="hover:text-blue-400 transition-colors"
              >
                djmurphy041@gmail.com
              </a>
              <a
                href="https://github.com/odionmurphy"
                target="_blank"
          ...
          <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 pt-6 mt-6 border-t border-white/10 text-xs text-gray-500">
            <div>© {new Date().getFullYear()} Murphy Odion Usunobun.</div>
            <div>Available for freelance and full-time opportunities.</div>
          </div>
        </footer>
        ...
        {cvOpen && (
          ...
          >
            ...
            >
              ...
              <React.Suspense
                fallback={
                  <div className="p-6 text-sm text-gray-600">Loading CV…</div>
                }
              >
